...
/** @type {string} */
const CACHE_VERSION = '1736254478|481463652';
/** @type {string} */
const CACHE_PREFIX = 'jolt-test-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'jolt-test.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["jolt-test.html","jolt-test.js","jolt-test.offline.html","jolt-test.icon.png","jolt-test.apple-touch-icon.png","jolt-test.audio.worklet.js","jolt-test.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["jolt-test.wasm","jolt-test.pck","jolt-test.side.wasm"];
